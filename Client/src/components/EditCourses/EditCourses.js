...
import FormEditCourses from "./FormEditCourses";
...
export default function EditCourses(props) {
  ...
  return (
    <div>
      ...
      >
        <DialogTitle id="responsive-dialog-title">{"Edit Courses"}</DialogTitle>
        <DialogContent>
          <FormEditCourses idCourses={props.idCourses}></FormEditCourses>
        </DialogContent>
      </Dialog>
    </div>
  );
